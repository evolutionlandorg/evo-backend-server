        ...
        "/apostle/list": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Whether to filter all lands. If it is empty, only filter my lands,default is 'all'",
                        "name": "display",
                        "in": "query"
                    },
                    {
        ...
        "/lands": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "network district, polygon:5,crab:3,eth:1,heco:4,tron:2. default is 1",
                        "name": "district",
                        "in": "query"
                    },
                    {
